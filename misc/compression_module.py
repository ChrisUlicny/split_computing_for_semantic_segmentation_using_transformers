...
class compression_module(nn.Module):
    def __init__(self,  input_channel=256, hidden_channel=128, noise=10, channel = 1,spatial = 0):
        ...
        self.conv2 = nn.ConvTranspose2d(hidden_channel,input_channel,kernel_size = 3,stride=1,padding=1)
...
# edge AI algoritmus
# vyberanie spiltu a exitu pomocou datarateu
# deep learnning algoritmus, transformer vramci predikcie
# trasformery Reinforcment learning
# hierarchical RNNS-Based transformer -> pre vyber splitu a early exitu MADDPG