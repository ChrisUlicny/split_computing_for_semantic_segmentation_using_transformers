...
from simulation_code.simulations.sc_ee_simulation.simulation.maddpg import MADDPG
...
class MainSimulation(IISMotionSimulation):
    ...
    def obs_list_to_state_vector(self, observation):
        ...
        return state
    # TODO: here we get stats from event listener and put it into stats collector, from there to text files
    ...
    def collect_data(self, context: SimulationContext) -> None:
        self.stats_collector.timestamp = context.sim_info.simulation_step
        self.stats_collector.exit = avg_exit
        self.stats_collector.split = ue.strategy.split
        self.stats_collector.latency = avg_latency
...
# TODO: prerobit zber dat - zapisovat priebezne do suborov radsej, bere miesto na RAMKE - Tensorboard
# zapisat hocijake data
# namiesto listu do tensorboard cez statscollector